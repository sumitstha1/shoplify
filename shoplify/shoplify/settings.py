...
SECRET_KEY = 'django-insecure-br18ym$rpq5d$te(0io!el4a$!dcmcg1)+o2^gj!)y2m$ebp(a'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'base.context_processor.base_processor',
            ],
        },
    },
]
...
EMAIL_HOST_USER = 'sumit.stha911@gmail.com' # host gmail account
EMAIL_HOST_PASSWORD = 'mxiuszvegcwezgmp' # host gmail app password
